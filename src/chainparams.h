 ...
 * Sling system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string CoinMixPoolDummyAddress() const { return strCoinMixPoolDummyAddress; }
...
protected:
    ...
    std::string strCoinMixPoolDummyAddress;

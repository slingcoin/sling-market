...
public:
    CMainParams()
    {
        ...
        nMaturity = 5; //TODO: CryptoDJ, increase to 100
        ...
        fHeadersFirstSyncingActive = false; //TODO: CryptoDJ, change back to true
...
public:
    CTestNetParams()
    {
        ...
        nFirstPoSBlock = 11;
        nMaturity = 10;
        nModifierUpdateBlock = 51197; //TODO: CryptoDJ, remove this parameters.
        startNewChain = false;

        genesis = CreateGenesisBlock(1503221235, 0, Convert_UintToArith256_GetCompact(bnProofOfWorkLimit), 1, (1.337 * COIN));
        if(startNewChain == true) {
            MineGenesis(genesis, bnProofOfWorkLimit, true);
        }

        hashGenesisBlock = genesis.GetHash();
        //assert(hashGenesisBlock == uint256("0x0")); //TODO: CryptoDJ, add testnet genesis
        //assert(genesis.hashMerkleRoot == uint256("0xf293f656ff77eec4907e62a2d68ccc4e31fe9dc6d12b5846f3ef33268abb3a3b"));

                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("CoinMix Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::CoinMixMakeCollaterals));
    typeWidget->addItem(tr("CoinMix Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::CoinMixCreateDenominations));
    typeWidget->addItem(tr("CoinMix Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::CoinMixDenominate));
    typeWidget->addItem(tr("CoinMix Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::CoinMixCollateralPayment));

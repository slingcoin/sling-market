Contributing to Sling Market Core
============================

The Sling Market Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Sling Core project, and is not to be
confused with overall Sling Network Protocol consensus changes.

Whether a pull request is merged into Sling Core rests with the project merge
...
Patches that change Sling consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sling consensus, it must have been
...
The project leader is the release manager for each Sling Market Core release.

...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::RecvWithCoinMix:
        return tr("Received via CoinMix");
    ...
    case TransactionRecord::Generated:
        return tr("Mined");
    case TransactionRecord::CoinMixDenominate:
        return tr("CoinMix Denominate");
    case TransactionRecord::CoinMixCollateralPayment:
        return tr("CoinMix Collateral Payment");
    case TransactionRecord::CoinMixMakeCollaterals:
        return tr("CoinMix Make Collateral Inputs");
    case TransactionRecord::CoinMixCreateDenominations:
        return tr("CoinMix Create Denominations");

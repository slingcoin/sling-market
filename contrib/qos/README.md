...
This means one can have an always-on slingd instance running, and another local slingd/sling-qt instance which connects to this node and receives blocks from it.

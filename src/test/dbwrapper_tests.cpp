...
BOOST_AUTO_TEST_CASE(dbwrapper)
{
    ...
    for (bool obfuscate : {false, true}) {
        ...
        // Ensure that we're doing real coinmix when obfuscate=true
...
BOOST_AUTO_TEST_CASE(dbwrapper_iterator)
{
    ...
    for (bool obfuscate : {false, true}) {
        ...
        // Be sure to seek past the coinmix key (if it exists)
        it->Seek(key);
...
// Test that we do not coinmix if there is existing data.

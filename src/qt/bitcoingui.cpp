                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sling Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sling address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sling: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sling Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sling Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sling"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sling addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sling addresses"));
    ...
    openAction->setStatusTip(tr("Open a Sling: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sling Core help message to get a list with possible Sling command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sling Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Sling Core"); // default title
